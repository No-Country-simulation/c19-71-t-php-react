...
const API_USERS = 'https://dummyjson.com/auth/login'
    ...
    <div className=' h-full w-full md:h-[610px] md:w-[539px] bg-[#D9D9D9] rounded-[40px] px-[60px] md:py-[86px] py-10'>
     ...
     <form onSubmit={onSubmit}>
      <div className=' h-full w-full flex flex-col items-center gap-8 md:gap-16'>
        <input type='text' name='usuio' id='user' required className='md:w-[405px] md:h-[80px] rounded-[10px] md:px-[20px] p-2 md:text-lg' placeholder='USUARIO O CORREO ELECTRÓNICO' />
        <input type='password' name='contraseña' id='password' required className='md:w-[405px] md:h-[80px] rounded-[10px] md:px-[20px] p-2 md:text-lg' placeholder='CONTRASEÑA' />
